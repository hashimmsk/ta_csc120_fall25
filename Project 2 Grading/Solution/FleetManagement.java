...
public class FleetManagement {
    //----------------------------------------------------------------------------------------------------
    /**
     * Global Scanner object to use the keyboard for input
     */
    private static final Scanner keyboard = new Scanner(System.in);
    //----------------------------------------------------------------------------------------------------
    /**
     * The name of the database file where the fleet data is saved
     */
    ...
    public static void loadFleetData(String[] args, Fleet fleet) {
        ...
        if (args.length > 0) {
            ...
            // Subsequent runs: Load from serialized .db file
    ...
    } // end of the loadFleetData method
    //----------------------------------------------------------------------------------------------------
    /**
    ...
    } // end of the saveFleetData method
    //----------------------------------------------------------------------------------------------------
    /**
